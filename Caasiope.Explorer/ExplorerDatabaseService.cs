...
{
    public interface IExplorerDatabaseService
    {
        ReadDatabaseManager ReadDatabaseManager { get; }
    }

    public class ExplorerDatabaseService : IExplorerDatabaseService
    {
        public ReadDatabaseManager ReadDatabaseManager { get; set; }

        public ExplorerDatabaseService()
        {
            ReadDatabaseManager = new ReadDatabaseManager(new RepositoryManager());
        }
    }
