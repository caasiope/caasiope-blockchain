...
{
    public class LedgerSignatureSqlTransaction : SqlTransaction<Signature>
    {
        private readonly long height;
        public LedgerSignatureSqlTransaction(Signature signature, long height) : base(signature)
        {
            this.height = height;
        }
        ...
        {
            repositories.GetRepository<LedgerSignatureRepository>().CreateOrUpdate(entities, new LedgerSignature(Data, height));
        }
    }
