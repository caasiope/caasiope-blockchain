...
using Caasiope.NBitcoin.BouncyCastle.math.ec.multiplier;
using Caasiope.NBitcoin.BouncyCastle.security;

namespace Caasiope.NBitcoin.BouncyCastle.crypto.signers
{
	/**
