...
namespace Caasiope.NBitcoin.Crypto
{
	...
	{
		#region Hash256
        public static Hash256 Hash256(byte[] data)
		{
			return Hash256(data, 0, data.Length);
		}

        public static Hash256 Hash256(byte[] data, int count)
		{
            return Hash256(data.SafeSubarray(0, count));
		}

        public static Hash256 Hash256(byte[] data, int offset, int count)
		{
			...
			using(var sha = new SHA256Managed())
			{
                ...
                return new Hash256(sha.ComputeHash(h, 0, h.Length));
			}
#endif
		}
		#endregion
